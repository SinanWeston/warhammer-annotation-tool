...
Reads scripts/phase1/labels.csv (must have a `split` column from auto_split.py)
and copies each crop to:

    scripts/phase1/gallery/{faction}/{unit_slug}/{crop_basename}
    scripts/phase1/queries/{faction}/{unit_slug}/{crop_basename}
