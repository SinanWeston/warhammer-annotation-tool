...
Reads scripts/phase3/labels.csv (must have a `split` column from auto_split.py)
and copies each crop to:

    scripts/phase3/gallery/{faction}/{unit_slug}/{crop_basename}
    scripts/phase3/queries/{faction}/{unit_slug}/{crop_basename}
