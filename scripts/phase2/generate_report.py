...
def main():
    ...
    lines.append("")
    lines.append("```bash")
    lines.append("fiftyone_env/bin/python3 scripts/phase2/extract_more_crops.py")
    lines.append("# fill remaining unit_slug rows via warhammer-analyzer labeller")
    lines.append("fiftyone_env/bin/python3 scripts/phase2/auto_split.py")
    lines.append("fiftyone_env/bin/python3 scripts/phase2/build_gallery.py")
    lines.append("fiftyone_env/bin/python3 scripts/phase2/embed_gallery.py")
    lines.append("fiftyone_env/bin/python3 scripts/phase2/eval_scoped_retrieval.py")
    lines.append("fiftyone_env/bin/python3 scripts/phase2/generate_report.py")
    lines.append("```")
    lines.append("")
